...
public class ShopUtil{
	...
	public void init(){
		...
		users[0].setPasswd("123");
		users[0].setMoney(10000);
	...
	public void view(){
		...
		do{
			...
			while(!isContinueFlag){
				if(isContinue.equals("y")||isContinue.equals("Y")||isContinue.equals("n")||isContinue.equals("N")){
					isContinueFlag = true;
				}else{
			...
			isBuyCountinue = (isContinue.toUpperCase().equals("Y"))?true:false;
